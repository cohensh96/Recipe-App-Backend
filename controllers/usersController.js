/**
 * Importing the necessary models and dependencies required for user management.
 */
...
const getUserJWT = async (req, res) => {
    ...
    // Set password and refresh token to "SECRET" for security reasons
    user.password = "SECRET-PASSWORD";
    user.refreshToken = "SECRET-REFRESH";
    res.json(user);
}
...
const updateUser = async (req, res) => {
    if (req?.body === undefined)
        return res.status(404).json({ "message": "Missing fields in user data" });
